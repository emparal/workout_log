...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { date: @workout.date, length: @workout.length, mood: @workout.mood, workout: @workout.workout }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { date: @workout.date, length: @workout.length, mood: @workout.mood, workout: @workout.workout }
    assert_redirected_to workout_path(assigns(:workout))
  end
